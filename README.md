...
In the end I settled on using Highcharts along with Ionic (via CDN), though it is worth noting that the library is only free for non-commercial use such as this.
...
I have also built a feature to allow you to animate you travels.
